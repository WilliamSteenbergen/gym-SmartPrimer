...
from gym_SmartPrimer.envs.Deterministic.ChildClass import Child
import numpy as np
from gym_SmartPrimer.envs.Deterministic import ChildBehavior
...
class SmartPrimerEnv(gym.Env):
	...
	def reset(self):
		...
		self.state = ChildBehavior.nextObservation(self.observation_space, self.child)
		return self.state
